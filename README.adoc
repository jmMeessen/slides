...
This repository is based on work done by Damien DUPORTAL (https://github.com/dduportal/slides). It is a framework managing all my slide deck,
...
Just create and push a new branch.
The new presentation will be built and available at https://jmmeessen.github.io/slides/branch_name.

TODO: explain how to publish the final presentation, update the presentation index and prepare for the next presentation.
